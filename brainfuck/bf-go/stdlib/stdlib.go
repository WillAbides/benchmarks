...
func (p *Program) Run(printer bf.Printer) {
...
func _run(program []Op, tape *Tape, p bf.Printer) {
...
func main() {
	err := bf.Run(func(s string, printer bf.Printer) {
